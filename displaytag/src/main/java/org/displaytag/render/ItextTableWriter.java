...
public class ItextTableWriter extends TableWriterAdapter {
	...
	/**
	 * Initialize the main info holder table, like the appropriate number of
	 * columns.
	 * 
	 * @param model
	...
	/**
	 * Obtain the font used to render text in the table; Meant to be overriden
	 * if a different font is desired.
	 * 
	...
	/**
	 * Obtain the caption font; Meant to be overriden if a different style is
	 * desired.
	 * 
	...
	/**
	 * Obtain the caption horizontal alignment; Meant to be overriden if a
	...
	/**
	 * Obtain the footer background color; Meant to be overriden if a different
	 * style is desired.
	 * 
	...
	/**
	 * Obtain the footer horizontal alignment; Meant to be overriden if a
	 * different style is desired.
	 * 
	...
	/**
	 * Set the font style used to render the header text; Meant to be overridden
	 * if a different header style is desired.
	 * 
	 * @param cellContent
	...
	/**
	 * Obtain the footer font color; Meant to be overriden if a different style
	 * is desired.
	 * 
	...
	/**
	 * Obtain the footer font; Meant to be overriden if a different style is
	 * desired.
	 * 
	...
	/**
	 * Decorators that help render the table to an iText document must implement
	 * ItextDecorator.
	 * 
	...
	protected void writeColumnOpener(Column column) throws ObjectLookupException, DecoratorException {
		column.initialize(); // has side effect, setting its stringValue, which
								// affects grouping logic.
	}
	 ...
	 * @return Cell
	 * @throws BadElementException
	 *             if errors occurs while generating content.
	 */
	private Cell getCell(Object value) throws BadElementException {
		Cell cell = new Cell(
				new Chunk(StringUtils.trimToEmpty(ObjectUtils.toString(value)), this.defaultFont));
	...
	/**
	 * Obtain the font used to render the header text; Meant to be overridden if
	 * a different header font is desired.
	 * 
	...
	/**
	 * Obtain the background color used to render the header; Meant to be
	 * overridden if a different header background color is desired.
	 * 
	...
	/**
	 * Set the font color used to render the header text; Meant to be overridden
	 * if a different header style is desired.
	 * 
	...
	/**
	 * Obtain the horizontal alignment used to render header text; Meant to be
	 * overridden if a different alignment is desired.
	 * 
	...
	/**
	 * An implementor of this interface decorates tables and columns appearing
	 * in iText documents.
	 * 
	 * @author Jorge L. Barroso
